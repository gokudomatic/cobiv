...
create table core_tags (file_key int, path text, size int, file_date datetime, ext text, filename text);
...
create index core_tags_idx2 on core_tags(path,size,file_date,ext, filename);
