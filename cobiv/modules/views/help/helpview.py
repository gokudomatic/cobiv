...
from cobiv.modules.core.view import *

Builder.load_file(os.path.abspath(os.path.join(os.path.dirname(__file__),'help.kv')))


class HelpView(View, RstDocument):
    def __init__(self, **kwargs):
        super(HelpView, self).__init__(**kwargs)
        with open(os.path.join(os.path.abspath(os.path.join(os.path.dirname(__file__), "help.rst")))) as stream:
